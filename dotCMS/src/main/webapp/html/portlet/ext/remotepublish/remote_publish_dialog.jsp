...
<div style="width:500px;" dojoType="dijit.form.Form" id="publishForm">
		...
		<div class="fieldWrapper">
			...
			<div class="fieldValue">
				<div class="form-horizontal">
					<input type="radio" dojoType="dijit.form.RadioButton" checked="true" onChange="pushHandler.togglePublishExpireDivs()" value="<%= RemotePublishAjaxAction.DIALOG_ACTION_PUBLISH %>" name="wfIWantTo" id="iwtPublish" >
					<label for="iwtPublish"><%= LanguageUtil.get(pageContext, "push") %></label>&nbsp;

					<input type="radio" dojoType="dijit.form.RadioButton" onChange="pushHandler.togglePublishExpireDivs()" value="<%= RemotePublishAjaxAction.DIALOG_ACTION_EXPIRE %>" name="wfIWantTo" id="iwtExpire" >
					<label for="iwtExpire"><%= LanguageUtil.get(pageContext, "Remove") %></label>&nbsp;

					<input type="radio" dojoType="dijit.form.RadioButton" onChange="pushHandler.togglePublishExpireDivs()" value="<%= RemotePublishAjaxAction.DIALOG_ACTION_PUBLISH_AND_EXPIRE %>" name="wfIWantTo" id="iwtPublishExpire" >
		...
		<div class="buttonRow">
			...
			<button dojoType="dijit.form.Button" iconClass="cancelIcon" onClick="window.lastSelectedEnvironments = pushHandler.inialStateEnvs; pushHandler.inialStateEnvs = new Array();dijit.byId('remotePublisherDia').hide()" type="button" class="dijitButtonFlat">
